...
class EvaluacionPCResincronizacion extends Model 
{
   	protected $table = 'EvaluacionPCResincronizacion';
    ...
    {
        return $this->hasMany('App\Models\Resincronizacion\EvaluacionPCCriterioResincronizacion','idCriterio');
    }
