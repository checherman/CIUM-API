...
class CreateEvaluacionCalidadTable extends Migration {
	...
	public function up()
	{
		Schema::create('EvaluacionCalidad', function(Blueprint $table)
		{
			$table->integer('id', true);
			$table->string('idUsuario', 45)->nullable();
			$table->string('clues', 12)->nullable()->index('fk_CluesEvaluacionCalidad_idx');
