...
class CreateEvaluacionPCResincronizacionTable extends Migration {
	...
	public function up()
	{
		Schema::create('EvaluacionPCResincronizacion', function(Blueprint $table)
		{
	...
	{
		Schema::drop('EvaluacionPCResincronizacion');
	}
