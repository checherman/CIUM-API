...
class CreateEvaluacionCalidadResincronizacionTable extends Migration {
	...
	public function up()
	{
		Schema::create('EvaluacionCalidadResincronizacion', function(Blueprint $table)
		{
	...
	{
		Schema::drop('EvaluacionCalidadResincronizacion');
	}
